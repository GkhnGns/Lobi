...
<div class="panel panel-default">
  <div class="panel-heading">
    ...
    <h3 class="panel-title">VİP İLANLAR</h3>
  </div>
...
<?php 
$verisayisi = count($conn->query("select * from uyeler WHERE seviye='vip'",PDO::FETCH_ASSOC)->fetchAll());
	$gosterilecek = 50;
	$sayfa;
...
?>		
		...
		<?php } ?>
		<?php } else{ echo '<tr><td colspan="6"><div class="alert alert-warning" role="alert">Henüz vip ilan eklenmemiş!</div></td></tr>'; ?>  <?php } ?>
...
<?php 
			if($sayfa > 1){
				echo '<li><a href="vip-ilanlar.php?sayfa=1">İlk</a></li>';
				echo '<li><a title="önceki" href="vip-ilanlar.php?sayfa='.($sayfa-1).'"><span aria-hidden="true">&laquo;</span></a></li>';
			}
			...
			for($i = $sayfa - $ekgoster; $i <= $sayfa + $ekgoster;$i++){
				if($i > 0 && $i <= $sayfasayisi){
					if($i == $sayfa){
						...
						echo '<li><a href="vip-ilanlar.php?sayfa='.$i.'">'.$i.'</a></li>';
			...
			if($sayfa < $sayfasayisi){
				echo '<li><a title="sonraki" href="vip-ilanlar.php?sayfa='.($sayfa+1).'"><span aria-label="Next">&raquo;</span></a></li>';
				echo '<li><a href="vip-ilanlar.php?sayfa='.$sayfasayisi.'">Son</a></li>';

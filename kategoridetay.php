...
if($kat["seo"]!=$_GET["seo"]){
Header("Location:/kategori/".$kat["seo"]."/".$kat["id"]); exit();
}
?>
<!DOCTYPE html>
<html lang="tr">
...
<div class="col-md-12">
	...
	<span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span> <span class="blink">Platin İlanlar</span> 
	<span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span><span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span>
	<span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span></div></div>
...
?>
<div class="col-lg-4 col-mg-4 col-sm-6 col-xs-6">
<a href="ilan/<?php echo $Platin['seo']; ?>/<?php echo $Platin['id']; ?>.html" rel="nofollow">
<img class="img-responsive img-thumbnail VitrinUst" src="modelresim/<?php echo $Platin['resim']; ?>" alt="<?php echo $Platin['isim']; ?>" height="" width=""/>
</a>
</div>
<?php } ?>
<?php }else{ ?>
<div class="col-md-12"><div class="alert alert-warning text-center"><strong>Platin İlan Kaydı Bulunamadı...</strong></div></div>	
<?php } ?>
<div class="temizle"></div>	
<div class="col-md-12">
	<div class="vipilan">
		<span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span><span class="blink">Gold İlanlar</span> 
		<span class="glyphicon glyphicon-star-empty" aria-hidden="true"></span></div></div>
<div class="temizle"></div>	
...
<a href="ilan/<?php echo $Gold['seo']; ?>/<?php echo $Gold['id']; ?>.html" rel="nofollow">
<img class="img-responsive img-thumbnail VitrinUst" src="modelresim/<?php echo $Gold['resim']; ?>" alt="<?php echo $Gold['isim']; ?>" height="" width=""/>
</a>
</div>
<?php } ?>
<?php }else{ ?>
<div class="col-md-12"><div class="alert alert-warning text-center"><strong>Gold İlan Kaydı Bulunamadı...</strong></div></div>	
<?php } ?>
<div class="temizle"></div>
<br/>
<div class="col-md-8">	
...
<li class="active"><a href="kategori/<?php echo $kat['seo']; ?>/<?php echo $kat['id']; ?>.html"><?php echo $kat['baslik']; ?></a></li>
</ol>
<?php 
$sorustur = $conn->prepare("select * from blog where durum = ? and kategori = ? order by rand() limit 6");
$sorustur->execute(array('Aktif', $katid));
...
<div class="media">
<a class="pull-left" href="yazi/<?php echo $Makale['seo']; ?>/<?php echo $Makale['id']; ?>">
<div class="cerceve"><img src="blogresim/<?php echo $Makale['resim']; ?>" alt="<?php echo $Makale['baslik']; ?>" height="" width="" class="resim"></div>
</a>
<div class="panel-body">
...
<h5 class="panel-title"><center><?php echo $kat["baslik"]; ?></center></h5>
</div>
<div class="panel-body">
<iframe src="https://www.google.com/maps/embed/v1/place?key=<?php echo $SiteBilgi['mapsapi']; ?>&q=<?php echo $kat["odak"]; ?>" width="100%" height="300" frameborder="0" style="border:0" allowfullscreen></iframe>	 
</div>
</div>
</div>
<div class="temizle"></div>
...
<div class="panel panel-default panel-stili">
<div class="panel-heading">
<h3 class="panel-title"><?php echo $kat["baslik"]; ?></h3>
</div>
<div class="panel-body kategorialtyazi">
<p><?php echo $kat["aciklama"]; ?></p>
</div>
</div>	
</div>	
<div class="temizle"></div>

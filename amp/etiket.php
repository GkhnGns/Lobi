...
$BlogSql = $conn->query("SELECT * FROM uyeler WHERE anahtar LIKE '%".$EtiketBaslik."%' ");
}
?>
<!doctype html>
<html lang="tr-TR" amp>
...
<title><?php echo $EtiketBaslik; ?></title>
<link rel="canonical" href="<?php echo $SiteBilgi["siteurl"]; ?>ilan-etiket/<?php echo $tag; ?>.html"/>

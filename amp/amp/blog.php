...
<title>ilan Yazıları | <?php echo $SiteBilgi["logoyazi"]; ?></title>
<meta name="theme-color" content="">
<link rel="canonical" href="<?php echo $SiteBilgi["siteurl"]; ?>makaleler"/>
...
"@type":"NewsArticle",
"headline":"<?php echo $SiteBilgi["siteadi"]; ?>",
"url":"<?php echo $SiteBilgi["siteurl"]; ?>",
"datePublished":"2020-02-02T12:45:30+00:00",
"dateModified":"<?php echo date('Y-m-d'); ?>T<?php echo date('H:i:s'); ?>+00:00",
"mainEntityOfPage":{"@type":"WebPage","@id":"<?php echo $SiteBilgi["siteurl"]; ?>"},
"publisher":{"@type":"Organization",
"name":"<?php echo $SiteBilgi["siteadi"]; ?>",
"logo":{"@type":"ImageObject",
"url":"<?php echo $SiteBilgi["ampurl"]; ?>resim/esc.png",
"height":302,"width":182}},
"author":{"@type":"Person",
"name":"<?php echo $AmpBilgi["amp_baslik"]; ?> Yazıları"},
...
<div class="wrap">
<div class="text-center sitebaslik"><h1>ilan Yazıları</h1></div>
<div class="blog-liste">
<?php 
$verisayisi = count($conn->query("select * from blog",PDO::FETCH_ASSOC)->fetchAll());
$gosterilecek = 3;
$sayfa;
...
<?php 
if($sayfa > 1){
echo '<a class="prev page-numbers" href="'.$YeniAdres.'/Blog.html?sayfa='.($sayfa-1).'"><i class="fa fa-arrow-left" aria-hidden="true"></i>Önceki</a>';
}
$ekgoster = 2;
for($i = $sayfa - $ekgoster; $i <= $sayfa + $ekgoster;$i++){
if($i > 0 && $i <= $sayfasayisi){
if($i == $sayfa){
echo '<span class="page-numbers current"><span class="meta-nav screen-reader-text">Sayfa: '.$i.'</span></span>';
}else{
echo '<a class="page-numbers" href="'.$YeniAdres.'/Blog.html?sayfa='.$i.'"><span class="meta-nav screen-reader-text">'.$i.'</span></a>';
}
}
}
if($sayfa < $sayfasayisi){
echo '<a class="next page-numbers" href="'.$YeniAdres.'/Blog.html?sayfa='.($sayfa+1).'">Sonraki<i class="fa fa-arrow-right" aria-hidden="true"></i></a>';
}
?>
</div>
</div>

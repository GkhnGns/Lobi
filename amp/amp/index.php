...
<title><?php echo $SiteBilgi["siteadi"]; ?></title>
...
.ilan-liste-2 .post-thumbnail amp-img{max-width:100%; float:left; margin-right:7px;}
.ilan-liste-2 .post-title{font-size:18px;margin:0 0 10px}
...
"datePublished":"2020-01-29T12:45:30+00:00",
...
"author":{"@type":"Person",
"name":"<?php echo $AmpBilgi["amp_baslik"]; ?>"},
...
<div class="wrap">
<div class="text-center sitebaslik"><?php echo $SiteBilgi['ustalanyazisi']; ?></div>
...
<?php		
$Blogs = $conn->prepare("select * from blog where durum = ? order by id desc limit 10");
$Blogs->execute(array('Aktif'));
$count = $Blogs->rowcount();
if ($count > 0){ 

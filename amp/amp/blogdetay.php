...
require_once("../include/connect.php"); require_once("fonksiyon.php");
...
<title><?php echo $yaziYaz["baslik"]; ?> | <?php echo $SiteBilgi["logoyazi"]; ?></title>
<meta name="theme-color" content="">
<link rel="canonical" href="<?php echo $SiteBilgi["siteurl"]; ?>yazi/<?php echo $yaziYaz["seo"]; ?>/<?php echo $yaziYaz["id"]; ?>"/>
...
<script type="application/ld+json">{"@context":"https:\/\/schema.org","@type":"BlogPosting","mainEntityOfPage":"<?php echo $SiteBilgi["siteurl"]; ?>","publisher":{"@type":"Organization","name":"<?php echo $yaziYaz["baslik"]; ?>","logo":{"@type":"ImageObject","url":"<?php echo $SiteBilgi["siteurl"]; ?>blogresim/<?php echo $yaziYaz['resim']; ?>","height":400,"width":300}},"headline":"<?php echo $SiteBilgi["siteadi"]; ?>","datePublished":"<?php echo $yaziYaz["yil"]; ?>-<?php echo $yaziYaz["tarih"]; ?>T<?php echo $yaziYaz["saat"]; ?>+00:00","dateModified":"<?php echo date('Y-m-d'); ?>T<?php echo date('H:i:s'); ?>+00:00","author":{"@type":"Person","name":"<?php echo $AmpBilgi["amp_baslik"]; ?>"},"image":{"@type":"ImageObject","url":"<?php echo $SiteBilgi["ampurl"]; ?>resim/esc.png","height":200,"width":400}}</script>
</head>
...
<a class="left" href="<?php echo $YeniAdres; ?>">Vitrine Dön</a>
<a class="right" on="tap:istanbul-ampSidebar.toggle">Kategoriler</a>
</section>
<div class="text-center sitebaslik"><h1><?php echo $yaziYaz["baslik"]; ?></h1></div>

<div class="margintop20 clearfix"></div>

<div class="text-center detays">

<amp-img src="../blogresim/<?php echo $yaziYaz['resim']; ?>" width="400" height="400" alt="<?php echo $yaziYaz['baslik']; ?>"></amp-img>

<div class="margintop20 clearfix"></div>
<?php echo $yaziYaz['aciklama']; ?>
<div class="margintop20 clearfix"></div>
<amp-social-share type="facebook" width="40" height="30" data-param-text="<?php echo $yaziYaz['baslik']; ?>" data-param-attribution="AMPhtml" data-param-url="<?php echo $YeniAdres.'/ilan-'.$yaziYaz['seo'].'-'.$yaziYaz['id'].'.html'; ?>" data-param-media="<?php echo $SiteBilgi["siteurl"]; ?>blogresim/<?php echo $yaziYaz["resim"]; ?>"  data-param-app_id="000000000000000"></amp-social-share>
<amp-social-share type="pinterest" width="40" height="30" data-param-text="<?php echo $yaziYaz['baslik']; ?>" data-param-attribution="AMPhtml" data-param-url="<?php echo $YeniAdres.'/ilan-'.$yaziYaz['seo'].'-'.$yaziYaz['id'].'.html'; ?>" data-param-media="<?php echo $SiteBilgi["siteurl"]; ?>blogresim/<?php echo $yaziYaz["resim"]; ?>"></amp-social-share>
<amp-social-share type="tumblr" width="40" height="30" data-param-text="<?php echo $yaziYaz['baslik']; ?>" data-param-attribution="AMPhtml" data-param-url="<?php echo $YeniAdres.'/ilan-'.$yaziYaz['seo'].'-'.$yaziYaz['id'].'.html'; ?>" data-param-media="<?php echo $SiteBilgi["siteurl"]; ?>blogresim/<?php echo $yaziYaz["resim"]; ?>"></amp-social-share>
<amp-social-share type="twitter" width="40" height="30" data-param-text="<?php echo $yaziYaz['baslik']; ?>" data-param-attribution="AMPhtml" data-param-url="<?php echo $YeniAdres.'/ilan-'.$yaziYaz['seo'].'-'.$yaziYaz['id'].'.html'; ?>" data-param-media="<?php echo $SiteBilgi["siteurl"]; ?>blogresim/<?php echo $yaziYaz["resim"]; ?>"></amp-social-share>
<amp-social-share type="whatsapp" width="40" height="30" data-param-text="<?php echo $yaziYaz['baslik']; ?> - <?php echo $YeniAdres.'/ilan-'.$yaziYaz['seo'].'-'.$yaziYaz['id'].'.html'; ?>" data-param-attribution="AMPhtml" data-param-media="<?php echo $SiteBilgi["siteurl"]; ?>blogresim/<?php echo $yaziYaz["resim"]; ?>"></amp-social-share>
<div class="margintop20 clearfix"></div>
<?php 
...
echo '<a class="button" href="'.$YeniAdres.'/Tag-'.$etiket['seo'].'.html" data-toggle="tooltip" title="'.$etiket['baslik'].'"/>'.$etiket['baslik'].'</a> '; 
} 
?>
</div>
<div class="margintop20 clearfix"></div>
<div class="text-center sitebaslik"><h1>Diğer Yazılar</h1></div>
<?php 
$sorustur = $conn->prepare("SELECT * FROM blog WHERE durum = ? AND  id != ? ORDER BY id DESC LIMIT 10");
$sorustur->execute(array('Aktif', $url));
...
<div class="yan-cerceve"><amp-img src="../blogresim/<?php echo $Blog['resim']; ?>" alt="<?php echo $Blog['baslik']; ?>" height="100" width="100" class="yan-resim"></amp-img></div>
</a>
</div>
<div class="post-excerpt">
<p><?php $metin = mb_substr($Blog['aciklama'],0,500).'...'; echo strip_tags($metin); ?></p>
